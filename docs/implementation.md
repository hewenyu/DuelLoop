...
2026-09-23 的模型决策修订通过 147 项离线测试及独立安装检查：57 个公开类型、12 步 SDK 演示、安装包文档和领域模板均验证。领域合规 11 项通过、2 个未提供可选场景跳过；该次未调用收费模型。0.2.0 工程修复通过 184 项离线测试；当前 0.2.1 SDK 审计修复通过 221 项离线测试，完整范围见[当前验证摘要](validation.md)。
